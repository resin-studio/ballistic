...
is fairly standard, but there is one particular issue that deserves special attention. 
...
equivalent data-parallel operation for indexing a matrix with vector indices.
Thus, indexing is actually compiled into  
